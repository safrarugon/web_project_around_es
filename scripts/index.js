...
//---Funciones y eventos para la apertura y cierre de Modal
...
function closeModal(modal) {
  ...
  resetValidation(modal, submitButton);
}
...
//---Funciones y eventos del Modal de Perfil
//Función para llenar el formulario de perfil con los datos actuales del perfil
function fillProfileForm() {
  //Coloca los valores de nombre y descripción
...
//Función para abrir el modal de perfil y llenar el formulario con los datos actuales del perfil
...
//Función para guardar los datos del formulario de perfil en el contenedor de perfil
...
//---Funciones y eventos de Modal de Cards
//Función para abrir el modal de nuevo card
function handleOpenCardModal() {
  //Llamada a la función de apertura de modal de nuevo card
  openModal(newCardPopup);
}
//Función para colocar los valores del formulario de nuevo card en el contenedor de cards
...
//---Funciones y eventos de Renderizado de Cards
//Función para renderizar la card en el contenedor de cards
...
//Función para obtener el elemento card con los valores del formulario de nuevo card
...
//---Eventos para cerrar el modal de imagen
